// Exercise 1 — Refactor ES5 to Modern JS 

// Given this ES5 code, rewrite it using let/const, arrow functions, template literals, and destructuring. 
...
const describe = ({ name, age, city }) => `${name}, aged ${age}, lives in ${city}.`;
